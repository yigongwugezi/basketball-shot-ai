...
def build(run_dir: Path, *, slow_motion: bool = False, contaminated: bool = False) -> tuple[Path, Path]:
    ...
    representation_path = run_dir / "motion_representation_v1.json"
...
def render_html(data: dict[str, Any]) -> str:
    ...
    return f"""<!doctype html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>Motion Representation V1 Debugger</title>
